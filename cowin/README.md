...
Cowin API: [https://apisetu.gov.in/public/marketplace/api/cowin](https://apisetu.gov.in/public/marketplace/api/cowin)

## Steps

1. Enable less secure app in google account using the following link
	Link: [https://myaccount.google.com/lesssecureapps](https://myaccount.google.com/lesssecureapps)

	
2.  Write program and add varibale in the cowin.py and run
